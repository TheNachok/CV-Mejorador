...
2. Mejorar las descripciones de experiencia con verbos de acción y métricas cuando sea posible
3. Optimizar las habilidades para que sean más relevantes y mejor presentadas
4. Corregir ortografía, puntuación y gramática
5. Adaptar el tono según el área solicitada
6. Añadir secciones que falten si son relevantes
...
const response = await fetch("/api/improve", {
  ...
  return (
    <div style={styles.root}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@400;500&family=DM+Sans:wght@400;700;800&display=swap');
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dot1 { animation: blink 1.4s ease-in-out 0s infinite; }
        .dot2 { animation: blink 1.4s ease-in-out 0.2s infinite; }
        .dot3 { animation: blink 1.4s ease-in-out 0.4s infinite; }
